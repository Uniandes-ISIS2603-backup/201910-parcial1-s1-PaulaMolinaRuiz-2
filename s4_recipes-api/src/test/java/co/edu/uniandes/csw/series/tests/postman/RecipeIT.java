...
import co.edu.uniandes.csw.recipes.resources.RecipeResource;
import java.io.File;
...
public class RecipeIT {
    ...
    private static final String COLLECTION = "Recipe-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s4_recipes-api.war")//War del modulo api
                ...
                .addPackage(RecipeResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(RecipeDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
